...
class Var(object):
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '12.229.61.118:9166')) if not ON_HEROKU or getenv('FQDN', '12.229.61.118:9166') else APP_NAME+'.herokuapp.com'
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', '-1001881956753'))
